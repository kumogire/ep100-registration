...
<div class="margin">
<div class="s-12 l-4">
	<?php foreach (($totalvols?:array()) as $item): ?>
    <span>Total Volunteers: <?php echo $item['c']; ?></span><br />
	<?php endforeach; ?>
</div>
</div>
</div>
...
<div class="margin">
<div class="s-12 l-4">
	<?php foreach (($totalvolschecked?:array()) as $item): ?>
    <span>Total Volunteers Checked In: <?php echo $item['c']; ?></span><br />
	<?php endforeach; ?>
</div>
</div>
</div>
